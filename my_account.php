...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div id="accordion">
                <div class="card">
                    <div class="card-header text-center card-header p-0" id="headingOne">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed collapse_btn p-3" id="buttonOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                Mijn Gegevens
                            </button>
                        </h5>
                    </div>
            ...
            <div class="card">
                <div class="card-header text-center card-header p-0" id="headingTwo">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed collapse_btn p-3" id="buttonTwo" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            Mijn Bestellingen
                        </button>
                    </h5>
                </div>
